...
class FineTuneDataset(Dataset):
    def __init__(self, data_sources: Iterable[str], max_seq_len: int = 2048) -> None:
        ...
        Args:
            data_sources (Iterable[str]): a list of string path to where to load the dataset.
            max_seq_len (int, optional): prompt_tokens + completion_tokens length greater than this will be discarded. Defaults to 2048.
        """
